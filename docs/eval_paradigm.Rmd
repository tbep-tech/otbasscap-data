...
Janicki & Wade (1996) developed a linear regression model relating monthly average chlorophyll-a concentrations to cumulative TN loads over a three-month period (the concurrent month and two previous months). The model used data from across Tampa Bay during 1986--1991 and stratified the data by the month of the year and by bay segment, and it produced an R2 value of 0.73. 
