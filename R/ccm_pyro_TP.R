...
# OTB Pyro xmap TP load
ccm.otb.pyro.TP <- delay.CCM( LIBRARY='pyro_otb', TARGET='TP_otb',
                              EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb"),]) )
ccm.otb.pyro.TP.rho <- plot.CCM( ccm.otb.pyro.TP )
ccm.otb.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = 0 )
ccm.otb.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -1 ) 
ccm.otb.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -2 ) 
ccm.otb.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -3 ) 
ccm.otb.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -4 ) 
ccm.otb.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -5 ) 
ccm.otb.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -6 ) 
ccm.otb.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.TP, CCM.RHO=ccm.otb.pyro.TP.rho, DELAY = -7 ) 

# NW Pyro xmap TP load
ccm.nw.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_nw', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_nw"),]) )
ccm.nw.pyro.TP.rho <- plot.CCM( ccm.nw.pyro.TP )
ccm.nw.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = 0 )
ccm.nw.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -1 ) 
ccm.nw.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -2 ) 
ccm.nw.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -3 ) 
ccm.nw.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -4 ) 
ccm.nw.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -5 ) 
ccm.nw.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -6 ) 
ccm.nw.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.TP, CCM.RHO=ccm.nw.pyro.TP.rho, DELAY = -7 ) 

# NE Pyro xmap TP load
ccm.ne.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_ne', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_ne"),]) )
ccm.ne.pyro.TP.rho <- plot.CCM( ccm.ne.pyro.TP )
ccm.ne.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = 0 )
ccm.ne.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -1 ) 
ccm.ne.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -2 ) 
ccm.ne.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -3 ) 
ccm.ne.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -4 ) 
ccm.ne.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -5 ) 
ccm.ne.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -6 ) 
ccm.ne.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.TP, CCM.RHO=ccm.ne.pyro.TP.rho, DELAY = -7 )

# CW Pyro xmap TP load
ccm.cw.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_cw', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_cw"),]) )
ccm.cw.pyro.TP.rho <- plot.CCM( ccm.cw.pyro.TP )
ccm.cw.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = 0 )
ccm.cw.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -1 ) 
ccm.cw.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -2 ) 
ccm.cw.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -3 ) 
ccm.cw.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -4 ) 
ccm.cw.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -5 ) 
ccm.cw.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -6 ) 
ccm.cw.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.TP, CCM.RHO=ccm.cw.pyro.TP.rho, DELAY = -7 ) 

# CE Pyro xmap TP load
ccm.ce.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_ce', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_ce"),]) )
ccm.ce.pyro.TP.rho <- plot.CCM( ccm.ce.pyro.TP )
ccm.ce.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = 0 )
ccm.ce.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -1 ) 
ccm.ce.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -2 ) 
ccm.ce.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -3 ) 
ccm.ce.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -4 ) 
ccm.ce.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -5 ) 
ccm.ce.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -6 ) 
ccm.ce.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.TP, CCM.RHO=ccm.ce.pyro.TP.rho, DELAY = -7 ) 

# SW Pyro xmap TP load
ccm.sw.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_sw', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_sw"),]) )
ccm.sw.pyro.TP.rho <- plot.CCM( ccm.sw.pyro.TP )
ccm.sw.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = 0 )
ccm.sw.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -1 ) 
ccm.sw.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -2 ) 
ccm.sw.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -3 ) 
ccm.sw.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -4 ) 
ccm.sw.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -5 ) 
ccm.sw.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -6 ) 
ccm.sw.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.TP, CCM.RHO=ccm.sw.pyro.TP.rho, DELAY = -7 ) 

# SE Pyro xmap TP load
ccm.se.pyro.TP <- delay.CCM( LIBRARY='pyro_otb_se', TARGET='TP_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_se"),]) )
ccm.se.pyro.TP.rho <- plot.CCM( ccm.se.pyro.TP )
ccm.se.pyro.TP.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = 0 )
ccm.se.pyro.TP.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -1 ) 
ccm.se.pyro.TP.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -2 ) 
ccm.se.pyro.TP.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -3 ) 
ccm.se.pyro.TP.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -4 ) 
ccm.se.pyro.TP.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -5 ) 
ccm.se.pyro.TP.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -6 ) 
ccm.se.pyro.TP.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.TP, CCM.RHO=ccm.se.pyro.TP.rho, DELAY = -7 ) 
...
# Export outputs
save.image( file = "../data/ccm_pyro_TP.RData" )
write.csv( df.pval, file = "../data/ccm_pyro_TP_pvals.csv", row.names = FALSE )



# CCM figures --------------------------------------------------------------
png( "../figs/ccm_pyro_TP.png", width = 6, height = 10, units = 'in', res = 600 )
par(mfrow=c(4,2), mar=c(4,4.5,2,1))

plot.CCM.results( CCM.OUTPUT=ccm.otb.pyro.TP,
                  CCM.RHO=ccm.otb.pyro.TP.rho,
                  MAIN = "OTB segment", YLAB = TRUE,
                  PVAL=c(ccm.otb.pyro.TP.pval.d0$pval, 
                         ccm.otb.pyro.TP.pval.d1$pval, 
                         ccm.otb.pyro.TP.pval.d2$pval, 
                         ccm.otb.pyro.TP.pval.d3$pval, 
                         ccm.otb.pyro.TP.pval.d4$pval, 
                         ccm.otb.pyro.TP.pval.d5$pval, 
                         ccm.otb.pyro.TP.pval.d6$pval, 
                         ccm.otb.pyro.TP.pval.d7$pval ) )
plot(c(0,1),c(0,1),bty='n',xaxt='n',yaxt='n',xlab='',ylab='',col=rgb(0,0,0,0))
  text( x = 0, y = 0.95, pos = 4, cex = 1.3,
        labels = expression(italic("P. bahamense")*" xmap TP load"), )
...
plot.CCM.results( CCM.OUTPUT=ccm.nw.pyro.TP,
                  CCM.RHO=ccm.nw.pyro.TP.rho,
                  MAIN = "NW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.nw.pyro.TP.pval.d0$pval, 
                         ccm.nw.pyro.TP.pval.d1$pval, 
                         ccm.nw.pyro.TP.pval.d2$pval, 
                         ccm.nw.pyro.TP.pval.d3$pval, 
                         ccm.nw.pyro.TP.pval.d4$pval, 
                         ccm.nw.pyro.TP.pval.d5$pval, 
                         ccm.nw.pyro.TP.pval.d6$pval, 
                         ccm.nw.pyro.TP.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ne.pyro.TP,
                  CCM.RHO=ccm.ne.pyro.TP.rho,
                  MAIN = "NE sub-segment",
                  PVAL=c(ccm.ne.pyro.TP.pval.d0$pval, 
                         ccm.ne.pyro.TP.pval.d1$pval, 
                         ccm.ne.pyro.TP.pval.d2$pval, 
                         ccm.ne.pyro.TP.pval.d3$pval, 
                         ccm.ne.pyro.TP.pval.d4$pval, 
                         ccm.ne.pyro.TP.pval.d5$pval, 
                         ccm.ne.pyro.TP.pval.d6$pval, 
                         ccm.ne.pyro.TP.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.cw.pyro.TP,
                  CCM.RHO=ccm.cw.pyro.TP.rho,
                  MAIN = "CW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.cw.pyro.TP.pval.d0$pval, 
                         ccm.cw.pyro.TP.pval.d1$pval, 
                         ccm.cw.pyro.TP.pval.d2$pval, 
                         ccm.cw.pyro.TP.pval.d3$pval, 
                         ccm.cw.pyro.TP.pval.d4$pval, 
                         ccm.cw.pyro.TP.pval.d5$pval, 
                         ccm.cw.pyro.TP.pval.d6$pval, 
                         ccm.cw.pyro.TP.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ce.pyro.TP,
                  CCM.RHO=ccm.ce.pyro.TP.rho,
                  MAIN = "CE sub-segment",
                  PVAL=c(ccm.ce.pyro.TP.pval.d0$pval, 
                         ccm.ce.pyro.TP.pval.d1$pval, 
                         ccm.ce.pyro.TP.pval.d2$pval, 
                         ccm.ce.pyro.TP.pval.d3$pval, 
                         ccm.ce.pyro.TP.pval.d4$pval, 
                         ccm.ce.pyro.TP.pval.d5$pval, 
                         ccm.ce.pyro.TP.pval.d6$pval, 
                         ccm.ce.pyro.TP.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.sw.pyro.TP,
                  CCM.RHO=ccm.sw.pyro.TP.rho,
                  MAIN = "SW sub-segment", YLAB = TRUE, XLAB = TRUE,
                  PVAL=c(ccm.sw.pyro.TP.pval.d0$pval, 
                         ccm.sw.pyro.TP.pval.d1$pval, 
                         ccm.sw.pyro.TP.pval.d2$pval, 
                         ccm.sw.pyro.TP.pval.d3$pval, 
                         ccm.sw.pyro.TP.pval.d4$pval, 
                         ccm.sw.pyro.TP.pval.d5$pval, 
                         ccm.sw.pyro.TP.pval.d6$pval, 
                         ccm.sw.pyro.TP.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.se.pyro.TP,
                  CCM.RHO=ccm.se.pyro.TP.rho,
                  MAIN = "SE sub-segment", XLAB = TRUE,
                  PVAL=c(ccm.se.pyro.TP.pval.d0$pval, 
                         ccm.se.pyro.TP.pval.d1$pval, 
                         ccm.se.pyro.TP.pval.d2$pval, 
                         ccm.se.pyro.TP.pval.d3$pval, 
                         ccm.se.pyro.TP.pval.d4$pval, 
                         ccm.se.pyro.TP.pval.d5$pval, 
                         ccm.se.pyro.TP.pval.d6$pval, 
                         ccm.se.pyro.TP.pval.d7$pval ) )
