...
# OTB chl xmap TN load
ccm.otb.chl.TN <- delay.CCM( LIBRARY='chl_otb', TARGET='TN_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb"),]) )
ccm.otb.chl.TN.rho <- plot.CCM( ccm.otb.chl.TN )
ccm.otb.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = 0 )
ccm.otb.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -1 ) 
ccm.otb.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -2 ) 
ccm.otb.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -3 ) 
ccm.otb.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -4 ) 
ccm.otb.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -5 ) 
ccm.otb.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -6 ) 
ccm.otb.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.TN, CCM.RHO=ccm.otb.chl.TN.rho, DELAY = -7 ) 

# NW chl xmap TN load
ccm.nw.chl.TN <- delay.CCM( LIBRARY='chl_otb_nw', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_nw"),]) )
ccm.nw.chl.TN.rho <- plot.CCM( ccm.nw.chl.TN )
ccm.nw.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = 0 )
ccm.nw.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -1 ) 
ccm.nw.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -2 ) 
ccm.nw.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -3 ) 
ccm.nw.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -4 ) 
ccm.nw.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -5 ) 
ccm.nw.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -6 ) 
ccm.nw.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.TN, CCM.RHO=ccm.nw.chl.TN.rho, DELAY = -7 ) 

# NE chl xmap TN load
ccm.ne.chl.TN <- delay.CCM( LIBRARY='chl_otb_ne', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ne"),]) )
ccm.ne.chl.TN.rho <- plot.CCM( ccm.ne.chl.TN )
ccm.ne.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = 0 )
ccm.ne.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -1 ) 
ccm.ne.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -2 ) 
ccm.ne.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -3 ) 
ccm.ne.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -4 ) 
ccm.ne.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -5 ) 
ccm.ne.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -6 ) 
ccm.ne.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.TN, CCM.RHO=ccm.ne.chl.TN.rho, DELAY = -7 )

# CW chl xmap TN load
ccm.cw.chl.TN <- delay.CCM( LIBRARY='chl_otb_cw', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_cw"),]) )
ccm.cw.chl.TN.rho <- plot.CCM( ccm.cw.chl.TN )
ccm.cw.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = 0 )
ccm.cw.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -1 ) 
ccm.cw.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -2 ) 
ccm.cw.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -3 ) 
ccm.cw.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -4 ) 
ccm.cw.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -5 ) 
ccm.cw.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -6 ) 
ccm.cw.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.TN, CCM.RHO=ccm.cw.chl.TN.rho, DELAY = -7 ) 

# CE chl xmap TN load
ccm.ce.chl.TN <- delay.CCM( LIBRARY='chl_otb_ce', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ce"),]) )
ccm.ce.chl.TN.rho <- plot.CCM( ccm.ce.chl.TN )
ccm.ce.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = 0 )
ccm.ce.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -1 ) 
ccm.ce.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -2 ) 
ccm.ce.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -3 ) 
ccm.ce.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -4 ) 
ccm.ce.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -5 ) 
ccm.ce.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -6 ) 
ccm.ce.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.TN, CCM.RHO=ccm.ce.chl.TN.rho, DELAY = -7 ) 

# SW chl xmap TN load
ccm.sw.chl.TN <- delay.CCM( LIBRARY='chl_otb_sw', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_sw"),]) )
ccm.sw.chl.TN.rho <- plot.CCM( ccm.sw.chl.TN )
ccm.sw.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = 0 )
ccm.sw.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -1 ) 
ccm.sw.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -2 ) 
ccm.sw.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -3 ) 
ccm.sw.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -4 ) 
ccm.sw.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -5 ) 
ccm.sw.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -6 ) 
ccm.sw.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.TN, CCM.RHO=ccm.sw.chl.TN.rho, DELAY = -7 ) 

# SE chl xmap TN load
ccm.se.chl.TN <- delay.CCM( LIBRARY='chl_otb_se', TARGET='TN_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_se"),]) )
ccm.se.chl.TN.rho <- plot.CCM( ccm.se.chl.TN )
ccm.se.chl.TN.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = 0 )
ccm.se.chl.TN.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -1 ) 
ccm.se.chl.TN.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -2 ) 
ccm.se.chl.TN.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -3 ) 
ccm.se.chl.TN.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -4 ) 
ccm.se.chl.TN.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -5 ) 
ccm.se.chl.TN.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -6 ) 
ccm.se.chl.TN.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.TN, CCM.RHO=ccm.se.chl.TN.rho, DELAY = -7 ) 
...
# Export outputs
save.image( file = "../data/ccm_chl00_TN.RData" )
write.csv( df.pval, file = "../data/ccm_chl00_TN_pvals.csv", row.names = FALSE )


# CCM figures --------------------------------------------------------------
png( "../figs/ccm_chl00_TN.png", width = 6, height = 10, units = 'in', res = 600 )
...
text( x = 0, y = 0.95, pos = 4, cex = 1.3,
      labels = "Chlorophyll-a xmap TN load" )
...
plot.CCM.results( CCM.OUTPUT=ccm.nw.chl.TN,
                  CCM.RHO=ccm.nw.chl.TN.rho,
                  MAIN = "NW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.nw.chl.TN.pval.d0$pval, 
                         ccm.nw.chl.TN.pval.d1$pval, 
                         ccm.nw.chl.TN.pval.d2$pval, 
                         ccm.nw.chl.TN.pval.d3$pval, 
                         ccm.nw.chl.TN.pval.d4$pval, 
                         ccm.nw.chl.TN.pval.d5$pval, 
                         ccm.nw.chl.TN.pval.d6$pval, 
                         ccm.nw.chl.TN.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ne.chl.TN,
                  CCM.RHO=ccm.ne.chl.TN.rho,
                  MAIN = "NE sub-segment",
                  PVAL=c(ccm.ne.chl.TN.pval.d0$pval, 
                         ccm.ne.chl.TN.pval.d1$pval, 
                         ccm.ne.chl.TN.pval.d2$pval, 
                         ccm.ne.chl.TN.pval.d3$pval, 
                         ccm.ne.chl.TN.pval.d4$pval, 
                         ccm.ne.chl.TN.pval.d5$pval, 
                         ccm.ne.chl.TN.pval.d6$pval, 
                         ccm.ne.chl.TN.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.cw.chl.TN,
                  CCM.RHO=ccm.cw.chl.TN.rho,
                  MAIN = "CW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.cw.chl.TN.pval.d0$pval, 
                         ccm.cw.chl.TN.pval.d1$pval, 
                         ccm.cw.chl.TN.pval.d2$pval, 
                         ccm.cw.chl.TN.pval.d3$pval, 
                         ccm.cw.chl.TN.pval.d4$pval, 
                         ccm.cw.chl.TN.pval.d5$pval, 
                         ccm.cw.chl.TN.pval.d6$pval, 
                         ccm.cw.chl.TN.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ce.chl.TN,
                  CCM.RHO=ccm.ce.chl.TN.rho,
                  MAIN = "CE sub-segment",
                  PVAL=c(ccm.ce.chl.TN.pval.d0$pval, 
                         ccm.ce.chl.TN.pval.d1$pval, 
                         ccm.ce.chl.TN.pval.d2$pval, 
                         ccm.ce.chl.TN.pval.d3$pval, 
                         ccm.ce.chl.TN.pval.d4$pval, 
                         ccm.ce.chl.TN.pval.d5$pval, 
                         ccm.ce.chl.TN.pval.d6$pval, 
                         ccm.ce.chl.TN.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.sw.chl.TN,
                  CCM.RHO=ccm.sw.chl.TN.rho,
                  MAIN = "SW sub-segment", YLAB = TRUE, XLAB = TRUE,
                  PVAL=c(ccm.sw.chl.TN.pval.d0$pval, 
                         ccm.sw.chl.TN.pval.d1$pval, 
                         ccm.sw.chl.TN.pval.d2$pval, 
                         ccm.sw.chl.TN.pval.d3$pval, 
                         ccm.sw.chl.TN.pval.d4$pval, 
                         ccm.sw.chl.TN.pval.d5$pval, 
                         ccm.sw.chl.TN.pval.d6$pval, 
                         ccm.sw.chl.TN.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.se.chl.TN,
                  CCM.RHO=ccm.se.chl.TN.rho,
                  MAIN = "SE sub-segment", XLAB = TRUE,
                  PVAL=c(ccm.se.chl.TN.pval.d0$pval, 
                         ccm.se.chl.TN.pval.d1$pval, 
                         ccm.se.chl.TN.pval.d2$pval, 
                         ccm.se.chl.TN.pval.d3$pval, 
                         ccm.se.chl.TN.pval.d4$pval, 
                         ccm.se.chl.TN.pval.d5$pval, 
                         ccm.se.chl.TN.pval.d6$pval, 
