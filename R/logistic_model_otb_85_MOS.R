...
# Logistic model
  ...
  # Plot predictions
  png( "../figs/logistic_model_otb_85_MOS.png", width = 7, height = 7, units = 'in', res = 600 )
  par(mar=c(4.5,4,2,1))
  plot( median ~ TN_load, data = plot_data, type = 'l',
        col = rgb(0.3,0.7,1,1), lwd = 2,
        ylim = c(0,1), xlim = c(0,150), las = 1,
        main = paste0("Probability of attaining ",chl_target," ug/L target"),
