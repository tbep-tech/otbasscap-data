# This script computes correlations between Pyro abundance (FWC data) and
# chlorophyll-a concentrations (EPC data), for OTB sub-segments. The two
# datasets are paired on a monthly time frame.
...
# Plotting parameters
png( "../figs/pyro_chl_corr_fwc.png", height = 9, width = 9, units = 'in', res = 500 )
