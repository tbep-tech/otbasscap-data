...
# Assemble embedding parameters for response variables (chl & pyro)
...
# OTB Pyro xmap temperature
ccm.otb.pyro.temp <- delay.CCM( LIBRARY='pyro_otb', TARGET='temp_otb',
                              EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb"),]) )
ccm.otb.pyro.temp.rho <- plot.CCM( ccm.otb.pyro.temp )
ccm.otb.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = 0 )
ccm.otb.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -1 ) 
ccm.otb.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -2 ) 
ccm.otb.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -3 ) 
ccm.otb.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -4 ) 
ccm.otb.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -5 ) 
ccm.otb.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -6 ) 
ccm.otb.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.otb.pyro.temp, CCM.RHO=ccm.otb.pyro.temp.rho, DELAY = -7 ) 

# NW Pyro xmap temperature
ccm.nw.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_nw', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_nw"),]) )
ccm.nw.pyro.temp.rho <- plot.CCM( ccm.nw.pyro.temp )
ccm.nw.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = 0 )
ccm.nw.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -1 ) 
ccm.nw.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -2 ) 
ccm.nw.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -3 ) 
ccm.nw.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -4 ) 
ccm.nw.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -5 ) 
ccm.nw.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -6 ) 
ccm.nw.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.nw.pyro.temp, CCM.RHO=ccm.nw.pyro.temp.rho, DELAY = -7 ) 

# NE Pyro xmap temperature
ccm.ne.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_ne', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_ne"),]) )
ccm.ne.pyro.temp.rho <- plot.CCM( ccm.ne.pyro.temp )
ccm.ne.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = 0 )
ccm.ne.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -1 ) 
ccm.ne.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -2 ) 
ccm.ne.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -3 ) 
ccm.ne.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -4 ) 
ccm.ne.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -5 ) 
ccm.ne.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -6 ) 
ccm.ne.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ne.pyro.temp, CCM.RHO=ccm.ne.pyro.temp.rho, DELAY = -7 )

# CW Pyro xmap temperature
ccm.cw.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_cw', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_cw"),]) )
ccm.cw.pyro.temp.rho <- plot.CCM( ccm.cw.pyro.temp )
ccm.cw.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = 0 )
ccm.cw.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -1 ) 
ccm.cw.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -2 ) 
ccm.cw.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -3 ) 
ccm.cw.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -4 ) 
ccm.cw.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -5 ) 
ccm.cw.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -6 ) 
ccm.cw.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.cw.pyro.temp, CCM.RHO=ccm.cw.pyro.temp.rho, DELAY = -7 ) 

# CE Pyro xmap temperature
ccm.ce.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_ce', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_ce"),]) )
ccm.ce.pyro.temp.rho <- plot.CCM( ccm.ce.pyro.temp )
ccm.ce.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = 0 )
ccm.ce.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -1 ) 
ccm.ce.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -2 ) 
ccm.ce.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -3 ) 
ccm.ce.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -4 ) 
ccm.ce.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -5 ) 
ccm.ce.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -6 ) 
ccm.ce.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ce.pyro.temp, CCM.RHO=ccm.ce.pyro.temp.rho, DELAY = -7 ) 

# SW Pyro xmap temperature
ccm.sw.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_sw', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_sw"),]) )
ccm.sw.pyro.temp.rho <- plot.CCM( ccm.sw.pyro.temp )
ccm.sw.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = 0 )
ccm.sw.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -1 ) 
ccm.sw.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -2 ) 
ccm.sw.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -3 ) 
ccm.sw.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -4 ) 
ccm.sw.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -5 ) 
ccm.sw.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -6 ) 
ccm.sw.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.sw.pyro.temp, CCM.RHO=ccm.sw.pyro.temp.rho, DELAY = -7 ) 

# SE Pyro xmap temperature
ccm.se.pyro.temp <- delay.CCM( LIBRARY='pyro_otb_se', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="pyro_otb_se"),]) )
ccm.se.pyro.temp.rho <- plot.CCM( ccm.se.pyro.temp )
ccm.se.pyro.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = 0 )
ccm.se.pyro.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -1 ) 
ccm.se.pyro.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -2 ) 
ccm.se.pyro.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -3 ) 
ccm.se.pyro.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -4 ) 
ccm.se.pyro.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -5 ) 
ccm.se.pyro.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -6 ) 
ccm.se.pyro.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.se.pyro.temp, CCM.RHO=ccm.se.pyro.temp.rho, DELAY = -7 ) 
...
# Export outputs
save.image( file = "../data/ccm_pyro_temp.RData" )
write.csv( df.pval, file = "../data/ccm_pyro_temp_pvals.csv", row.names = FALSE )



# CCM figures --------------------------------------------------------------
png( "../figs/ccm_pyro_temp.png", width = 6, height = 10, units = 'in', res = 600 )
par(mfrow=c(4,2), mar=c(4,4.5,2,1))

plot.CCM.results( CCM.OUTPUT=ccm.otb.pyro.temp,
                  CCM.RHO=ccm.otb.pyro.temp.rho,
                  MAIN = "OTB segment", YLAB = TRUE,
                  PVAL=c(ccm.otb.pyro.temp.pval.d0$pval, 
                         ccm.otb.pyro.temp.pval.d1$pval, 
                         ccm.otb.pyro.temp.pval.d2$pval, 
                         ccm.otb.pyro.temp.pval.d3$pval, 
                         ccm.otb.pyro.temp.pval.d4$pval, 
                         ccm.otb.pyro.temp.pval.d5$pval, 
                         ccm.otb.pyro.temp.pval.d6$pval, 
                         ccm.otb.pyro.temp.pval.d7$pval ) )
plot(c(0,1),c(0,1),bty='n',xaxt='n',yaxt='n',xlab='',ylab='',col=rgb(0,0,0,0))
  text( x = 0, y = 0.95, pos = 4, cex = 1.3,
        labels = expression(italic("P. bahamense")*" xmap temperature"), )
...
plot.CCM.results( CCM.OUTPUT=ccm.nw.pyro.temp,
                  CCM.RHO=ccm.nw.pyro.temp.rho,
                  MAIN = "NW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.nw.pyro.temp.pval.d0$pval, 
                         ccm.nw.pyro.temp.pval.d1$pval, 
                         ccm.nw.pyro.temp.pval.d2$pval, 
                         ccm.nw.pyro.temp.pval.d3$pval, 
                         ccm.nw.pyro.temp.pval.d4$pval, 
                         ccm.nw.pyro.temp.pval.d5$pval, 
                         ccm.nw.pyro.temp.pval.d6$pval, 
                         ccm.nw.pyro.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ne.pyro.temp,
                  CCM.RHO=ccm.ne.pyro.temp.rho,
                  MAIN = "NE sub-segment",
                  PVAL=c(ccm.ne.pyro.temp.pval.d0$pval, 
                         ccm.ne.pyro.temp.pval.d1$pval, 
                         ccm.ne.pyro.temp.pval.d2$pval, 
                         ccm.ne.pyro.temp.pval.d3$pval, 
                         ccm.ne.pyro.temp.pval.d4$pval, 
                         ccm.ne.pyro.temp.pval.d5$pval, 
                         ccm.ne.pyro.temp.pval.d6$pval, 
                         ccm.ne.pyro.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.cw.pyro.temp,
                  CCM.RHO=ccm.cw.pyro.temp.rho,
                  MAIN = "CW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.cw.pyro.temp.pval.d0$pval, 
                         ccm.cw.pyro.temp.pval.d1$pval, 
                         ccm.cw.pyro.temp.pval.d2$pval, 
                         ccm.cw.pyro.temp.pval.d3$pval, 
                         ccm.cw.pyro.temp.pval.d4$pval, 
                         ccm.cw.pyro.temp.pval.d5$pval, 
                         ccm.cw.pyro.temp.pval.d6$pval, 
                         ccm.cw.pyro.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ce.pyro.temp,
                  CCM.RHO=ccm.ce.pyro.temp.rho,
                  MAIN = "CE sub-segment",
                  PVAL=c(ccm.ce.pyro.temp.pval.d0$pval, 
                         ccm.ce.pyro.temp.pval.d1$pval, 
                         ccm.ce.pyro.temp.pval.d2$pval, 
                         ccm.ce.pyro.temp.pval.d3$pval, 
                         ccm.ce.pyro.temp.pval.d4$pval, 
                         ccm.ce.pyro.temp.pval.d5$pval, 
                         ccm.ce.pyro.temp.pval.d6$pval, 
                         ccm.ce.pyro.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.sw.pyro.temp,
                  CCM.RHO=ccm.sw.pyro.temp.rho,
                  MAIN = "SW sub-segment", YLAB = TRUE, XLAB = TRUE,
                  PVAL=c(ccm.sw.pyro.temp.pval.d0$pval, 
                         ccm.sw.pyro.temp.pval.d1$pval, 
                         ccm.sw.pyro.temp.pval.d2$pval, 
                         ccm.sw.pyro.temp.pval.d3$pval, 
                         ccm.sw.pyro.temp.pval.d4$pval, 
                         ccm.sw.pyro.temp.pval.d5$pval, 
                         ccm.sw.pyro.temp.pval.d6$pval, 
                         ccm.sw.pyro.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.se.pyro.temp,
                  CCM.RHO=ccm.se.pyro.temp.rho,
                  MAIN = "SE sub-segment", XLAB = TRUE,
                  PVAL=c(ccm.se.pyro.temp.pval.d0$pval, 
                         ccm.se.pyro.temp.pval.d1$pval, 
                         ccm.se.pyro.temp.pval.d2$pval, 
                         ccm.se.pyro.temp.pval.d3$pval, 
                         ccm.se.pyro.temp.pval.d4$pval, 
                         ccm.se.pyro.temp.pval.d5$pval, 
                         ccm.se.pyro.temp.pval.d6$pval, 
                         ccm.se.pyro.temp.pval.d7$pval ) )
