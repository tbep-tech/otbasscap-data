...
# OTB chl xmap temperature
ccm.otb.chl.temp <- delay.CCM( LIBRARY='chl_otb', TARGET='temp_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb"),]) )
ccm.otb.chl.temp.rho <- plot.CCM( ccm.otb.chl.temp )
ccm.otb.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = 0 )
ccm.otb.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -1 ) 
ccm.otb.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -2 ) 
ccm.otb.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -3 ) 
ccm.otb.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -4 ) 
ccm.otb.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -5 ) 
ccm.otb.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -6 ) 
ccm.otb.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.temp, CCM.RHO=ccm.otb.chl.temp.rho, DELAY = -7 ) 

# NW chl xmap temperature
ccm.nw.chl.temp <- delay.CCM( LIBRARY='chl_otb_nw', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_nw"),]) )
ccm.nw.chl.temp.rho <- plot.CCM( ccm.nw.chl.temp )
ccm.nw.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = 0 )
ccm.nw.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -1 ) 
ccm.nw.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -2 ) 
ccm.nw.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -3 ) 
ccm.nw.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -4 ) 
ccm.nw.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -5 ) 
ccm.nw.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -6 ) 
ccm.nw.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.temp, CCM.RHO=ccm.nw.chl.temp.rho, DELAY = -7 ) 

# NE chl xmap temperature
ccm.ne.chl.temp <- delay.CCM( LIBRARY='chl_otb_ne', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ne"),]) )
ccm.ne.chl.temp.rho <- plot.CCM( ccm.ne.chl.temp )
ccm.ne.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = 0 )
ccm.ne.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -1 ) 
ccm.ne.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -2 ) 
ccm.ne.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -3 ) 
ccm.ne.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -4 ) 
ccm.ne.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -5 ) 
ccm.ne.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -6 ) 
ccm.ne.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.temp, CCM.RHO=ccm.ne.chl.temp.rho, DELAY = -7 )

# CW chl xmap temperature
ccm.cw.chl.temp <- delay.CCM( LIBRARY='chl_otb_cw', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_cw"),]) )
ccm.cw.chl.temp.rho <- plot.CCM( ccm.cw.chl.temp )
ccm.cw.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = 0 )
ccm.cw.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -1 ) 
ccm.cw.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -2 ) 
ccm.cw.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -3 ) 
ccm.cw.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -4 ) 
ccm.cw.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -5 ) 
ccm.cw.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -6 ) 
ccm.cw.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.temp, CCM.RHO=ccm.cw.chl.temp.rho, DELAY = -7 ) 

# CE chl xmap temperature
ccm.ce.chl.temp <- delay.CCM( LIBRARY='chl_otb_ce', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ce"),]) )
ccm.ce.chl.temp.rho <- plot.CCM( ccm.ce.chl.temp )
ccm.ce.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = 0 )
ccm.ce.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -1 ) 
ccm.ce.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -2 ) 
ccm.ce.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -3 ) 
ccm.ce.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -4 ) 
ccm.ce.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -5 ) 
ccm.ce.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -6 ) 
ccm.ce.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.temp, CCM.RHO=ccm.ce.chl.temp.rho, DELAY = -7 ) 

# SW chl xmap temperature
ccm.sw.chl.temp <- delay.CCM( LIBRARY='chl_otb_sw', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_sw"),]) )
ccm.sw.chl.temp.rho <- plot.CCM( ccm.sw.chl.temp )
ccm.sw.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = 0 )
ccm.sw.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -1 ) 
ccm.sw.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -2 ) 
ccm.sw.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -3 ) 
ccm.sw.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -4 ) 
ccm.sw.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -5 ) 
ccm.sw.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -6 ) 
ccm.sw.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.temp, CCM.RHO=ccm.sw.chl.temp.rho, DELAY = -7 ) 

# SE chl xmap temperature
ccm.se.chl.temp <- delay.CCM( LIBRARY='chl_otb_se', TARGET='temp_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_se"),]) )
ccm.se.chl.temp.rho <- plot.CCM( ccm.se.chl.temp )
ccm.se.chl.temp.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = 0 )
ccm.se.chl.temp.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -1 ) 
ccm.se.chl.temp.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -2 ) 
ccm.se.chl.temp.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -3 ) 
ccm.se.chl.temp.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -4 ) 
ccm.se.chl.temp.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -5 ) 
ccm.se.chl.temp.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -6 ) 
ccm.se.chl.temp.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.temp, CCM.RHO=ccm.se.chl.temp.rho, DELAY = -7 ) 
...
# Export outputs
save.image( file = "../data/ccm_chl00_temp.RData" )
write.csv( df.pval, file = "../data/ccm_chl00_temp_pvals.csv", row.names = FALSE )


# CCM figures --------------------------------------------------------------
png( "../figs/ccm_chl00_temp.png", width = 6, height = 10, units = 'in', res = 600 )
par(mfrow=c(4,2), mar=c(4,4.5,2,1))

plot.CCM.results( CCM.OUTPUT=ccm.otb.chl.temp,
                  CCM.RHO=ccm.otb.chl.temp.rho,
                  MAIN = "OTB segment", YLAB = TRUE,
                  PVAL=c(ccm.otb.chl.temp.pval.d0$pval, 
                         ccm.otb.chl.temp.pval.d1$pval, 
                         ccm.otb.chl.temp.pval.d2$pval, 
                         ccm.otb.chl.temp.pval.d3$pval, 
                         ccm.otb.chl.temp.pval.d4$pval, 
                         ccm.otb.chl.temp.pval.d5$pval, 
                         ccm.otb.chl.temp.pval.d6$pval, 
                         ccm.otb.chl.temp.pval.d7$pval ) )
plot(c(0,1),c(0,1),bty='n',xaxt='n',yaxt='n',xlab='',ylab='',col=rgb(0,0,0,0))
text( x = 0, y = 0.95, pos = 4, cex = 1.3,
      labels = "Chlorophyll-a xmap temperature" )
...
plot.CCM.results( CCM.OUTPUT=ccm.nw.chl.temp,
                  CCM.RHO=ccm.nw.chl.temp.rho,
                  MAIN = "NW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.nw.chl.temp.pval.d0$pval, 
                         ccm.nw.chl.temp.pval.d1$pval, 
                         ccm.nw.chl.temp.pval.d2$pval, 
                         ccm.nw.chl.temp.pval.d3$pval, 
                         ccm.nw.chl.temp.pval.d4$pval, 
                         ccm.nw.chl.temp.pval.d5$pval, 
                         ccm.nw.chl.temp.pval.d6$pval, 
                         ccm.nw.chl.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ne.chl.temp,
                  CCM.RHO=ccm.ne.chl.temp.rho,
                  MAIN = "NE sub-segment",
                  PVAL=c(ccm.ne.chl.temp.pval.d0$pval, 
                         ccm.ne.chl.temp.pval.d1$pval, 
                         ccm.ne.chl.temp.pval.d2$pval, 
                         ccm.ne.chl.temp.pval.d3$pval, 
                         ccm.ne.chl.temp.pval.d4$pval, 
                         ccm.ne.chl.temp.pval.d5$pval, 
                         ccm.ne.chl.temp.pval.d6$pval, 
                         ccm.ne.chl.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.cw.chl.temp,
                  CCM.RHO=ccm.cw.chl.temp.rho,
                  MAIN = "CW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.cw.chl.temp.pval.d0$pval, 
                         ccm.cw.chl.temp.pval.d1$pval, 
                         ccm.cw.chl.temp.pval.d2$pval, 
                         ccm.cw.chl.temp.pval.d3$pval, 
                         ccm.cw.chl.temp.pval.d4$pval, 
                         ccm.cw.chl.temp.pval.d5$pval, 
                         ccm.cw.chl.temp.pval.d6$pval, 
                         ccm.cw.chl.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ce.chl.temp,
                  CCM.RHO=ccm.ce.chl.temp.rho,
                  MAIN = "CE sub-segment",
                  PVAL=c(ccm.ce.chl.temp.pval.d0$pval, 
                         ccm.ce.chl.temp.pval.d1$pval, 
                         ccm.ce.chl.temp.pval.d2$pval, 
                         ccm.ce.chl.temp.pval.d3$pval, 
                         ccm.ce.chl.temp.pval.d4$pval, 
                         ccm.ce.chl.temp.pval.d5$pval, 
                         ccm.ce.chl.temp.pval.d6$pval, 
                         ccm.ce.chl.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.sw.chl.temp,
                  CCM.RHO=ccm.sw.chl.temp.rho,
                  MAIN = "SW sub-segment", YLAB = TRUE, XLAB = TRUE,
                  PVAL=c(ccm.sw.chl.temp.pval.d0$pval, 
                         ccm.sw.chl.temp.pval.d1$pval, 
                         ccm.sw.chl.temp.pval.d2$pval, 
                         ccm.sw.chl.temp.pval.d3$pval, 
                         ccm.sw.chl.temp.pval.d4$pval, 
                         ccm.sw.chl.temp.pval.d5$pval, 
                         ccm.sw.chl.temp.pval.d6$pval, 
                         ccm.sw.chl.temp.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.se.chl.temp,
                  CCM.RHO=ccm.se.chl.temp.rho,
                  MAIN = "SE sub-segment", XLAB = TRUE,
                  PVAL=c(ccm.se.chl.temp.pval.d0$pval, 
                         ccm.se.chl.temp.pval.d1$pval, 
                         ccm.se.chl.temp.pval.d2$pval, 
                         ccm.se.chl.temp.pval.d3$pval, 
                         ccm.se.chl.temp.pval.d4$pval, 
                         ccm.se.chl.temp.pval.d5$pval, 
                         ccm.se.chl.temp.pval.d6$pval, 
                         ccm.se.chl.temp.pval.d7$pval ) )
