...
# Export outputs
save.image( file = "../data/ccm_chl12_TN.RData" )
write.csv( df.pval, file = "../data/ccm_chl12_TN_pvals.csv", row.names = FALSE )


# CCM figures --------------------------------------------------------------
png( "../figs/ccm_chl12_TN.png", width = 6, height = 10, units = 'in', res = 600 )
