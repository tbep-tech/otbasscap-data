...
# OTB chl xmap discharge
ccm.otb.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb', TARGET='Qtarpon_otb',
                             EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb"),]) )
ccm.otb.chl.Qtarpon.rho <- plot.CCM( ccm.otb.chl.Qtarpon )
ccm.otb.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = 0 )
ccm.otb.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.otb.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.otb.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.otb.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.otb.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.otb.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.otb.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.otb.chl.Qtarpon, CCM.RHO=ccm.otb.chl.Qtarpon.rho, DELAY = -7 ) 

# NW chl xmap discharge
ccm.nw.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_nw', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_nw"),]) )
ccm.nw.chl.Qtarpon.rho <- plot.CCM( ccm.nw.chl.Qtarpon )
ccm.nw.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = 0 )
ccm.nw.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.nw.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.nw.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.nw.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.nw.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.nw.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.nw.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.nw.chl.Qtarpon, CCM.RHO=ccm.nw.chl.Qtarpon.rho, DELAY = -7 ) 

# NE chl xmap discharge
ccm.ne.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_ne', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ne"),]) )
ccm.ne.chl.Qtarpon.rho <- plot.CCM( ccm.ne.chl.Qtarpon )
ccm.ne.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = 0 )
ccm.ne.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.ne.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.ne.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.ne.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.ne.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.ne.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.ne.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ne.chl.Qtarpon, CCM.RHO=ccm.ne.chl.Qtarpon.rho, DELAY = -7 )

# CW chl xmap discharge
ccm.cw.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_cw', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_cw"),]) )
ccm.cw.chl.Qtarpon.rho <- plot.CCM( ccm.cw.chl.Qtarpon )
ccm.cw.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = 0 )
ccm.cw.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.cw.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.cw.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.cw.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.cw.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.cw.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.cw.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.cw.chl.Qtarpon, CCM.RHO=ccm.cw.chl.Qtarpon.rho, DELAY = -7 ) 

# CE chl xmap discharge
ccm.ce.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_ce', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_ce"),]) )
ccm.ce.chl.Qtarpon.rho <- plot.CCM( ccm.ce.chl.Qtarpon )
ccm.ce.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = 0 )
ccm.ce.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.ce.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.ce.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.ce.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.ce.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.ce.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.ce.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.ce.chl.Qtarpon, CCM.RHO=ccm.ce.chl.Qtarpon.rho, DELAY = -7 ) 

# SW chl xmap discharge
ccm.sw.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_sw', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_sw"),]) )
ccm.sw.chl.Qtarpon.rho <- plot.CCM( ccm.sw.chl.Qtarpon )
ccm.sw.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = 0 )
ccm.sw.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.sw.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.sw.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.sw.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.sw.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.sw.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.sw.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.sw.chl.Qtarpon, CCM.RHO=ccm.sw.chl.Qtarpon.rho, DELAY = -7 ) 

# SE chl xmap discharge
ccm.se.chl.Qtarpon <- delay.CCM( LIBRARY='chl_otb_se', TARGET='Qtarpon_otb',
                            EMB = as.list(embed_tbl[which(embed_tbl$var=="chl_otb_se"),]) )
ccm.se.chl.Qtarpon.rho <- plot.CCM( ccm.se.chl.Qtarpon )
ccm.se.chl.Qtarpon.pval.d0  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = 0 )
ccm.se.chl.Qtarpon.pval.d1  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -1 ) 
ccm.se.chl.Qtarpon.pval.d2  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -2 ) 
ccm.se.chl.Qtarpon.pval.d3  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -3 ) 
ccm.se.chl.Qtarpon.pval.d4  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -4 ) 
ccm.se.chl.Qtarpon.pval.d5  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -5 ) 
ccm.se.chl.Qtarpon.pval.d6  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -6 ) 
ccm.se.chl.Qtarpon.pval.d7  <- pval.CCM( CCM.OUTPUT=ccm.se.chl.Qtarpon, CCM.RHO=ccm.se.chl.Qtarpon.rho, DELAY = -7 ) 
...
# Export outputs
save.image( file = "../data/ccm_chl00_Qtarpon.RData" )
write.csv( df.pval, file = "../data/ccm_chl00_Qtarpon_pvals.csv", row.names = FALSE )


# CCM figures --------------------------------------------------------------
png( "../figs/ccm_chl00_Qtarpon.png", width = 6, height = 10, units = 'in', res = 600 )
par(mfrow=c(4,2), mar=c(4,4.5,2,1))

plot.CCM.results( CCM.OUTPUT=ccm.otb.chl.Qtarpon,
                  CCM.RHO=ccm.otb.chl.Qtarpon.rho,
                  MAIN = "OTB segment", YLAB = TRUE,
                  PVAL=c(ccm.otb.chl.Qtarpon.pval.d0$pval, 
                         ccm.otb.chl.Qtarpon.pval.d1$pval, 
                         ccm.otb.chl.Qtarpon.pval.d2$pval, 
                         ccm.otb.chl.Qtarpon.pval.d3$pval, 
                         ccm.otb.chl.Qtarpon.pval.d4$pval, 
                         ccm.otb.chl.Qtarpon.pval.d5$pval, 
                         ccm.otb.chl.Qtarpon.pval.d6$pval, 
                         ccm.otb.chl.Qtarpon.pval.d7$pval ) )
plot(c(0,1),c(0,1),bty='n',xaxt='n',yaxt='n',xlab='',ylab='',col=rgb(0,0,0,0))
text( x = 0, y = 0.95, pos = 4, cex = 1.3,
      labels = "Chlorophyll-a xmap discharge" )
text( x = 0, y = 0.85, pos = 4, cex = 1.3,
      labels = paste0("(2000\U2013","2023)") )
...
plot.CCM.results( CCM.OUTPUT=ccm.nw.chl.Qtarpon,
                  CCM.RHO=ccm.nw.chl.Qtarpon.rho,
                  MAIN = "NW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.nw.chl.Qtarpon.pval.d0$pval, 
                         ccm.nw.chl.Qtarpon.pval.d1$pval, 
                         ccm.nw.chl.Qtarpon.pval.d2$pval, 
                         ccm.nw.chl.Qtarpon.pval.d3$pval, 
                         ccm.nw.chl.Qtarpon.pval.d4$pval, 
                         ccm.nw.chl.Qtarpon.pval.d5$pval, 
                         ccm.nw.chl.Qtarpon.pval.d6$pval, 
                         ccm.nw.chl.Qtarpon.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ne.chl.Qtarpon,
                  CCM.RHO=ccm.ne.chl.Qtarpon.rho,
                  MAIN = "NE sub-segment",
                  PVAL=c(ccm.ne.chl.Qtarpon.pval.d0$pval, 
                         ccm.ne.chl.Qtarpon.pval.d1$pval, 
                         ccm.ne.chl.Qtarpon.pval.d2$pval, 
                         ccm.ne.chl.Qtarpon.pval.d3$pval, 
                         ccm.ne.chl.Qtarpon.pval.d4$pval, 
                         ccm.ne.chl.Qtarpon.pval.d5$pval, 
                         ccm.ne.chl.Qtarpon.pval.d6$pval, 
                         ccm.ne.chl.Qtarpon.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.cw.chl.Qtarpon,
                  CCM.RHO=ccm.cw.chl.Qtarpon.rho,
                  MAIN = "CW sub-segment", YLAB = TRUE,
                  PVAL=c(ccm.cw.chl.Qtarpon.pval.d0$pval, 
                         ccm.cw.chl.Qtarpon.pval.d1$pval, 
                         ccm.cw.chl.Qtarpon.pval.d2$pval, 
                         ccm.cw.chl.Qtarpon.pval.d3$pval, 
                         ccm.cw.chl.Qtarpon.pval.d4$pval, 
                         ccm.cw.chl.Qtarpon.pval.d5$pval, 
                         ccm.cw.chl.Qtarpon.pval.d6$pval, 
                         ccm.cw.chl.Qtarpon.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.ce.chl.Qtarpon,
                  CCM.RHO=ccm.ce.chl.Qtarpon.rho,
                  MAIN = "CE sub-segment",
                  PVAL=c(ccm.ce.chl.Qtarpon.pval.d0$pval, 
                         ccm.ce.chl.Qtarpon.pval.d1$pval, 
                         ccm.ce.chl.Qtarpon.pval.d2$pval, 
                         ccm.ce.chl.Qtarpon.pval.d3$pval, 
                         ccm.ce.chl.Qtarpon.pval.d4$pval, 
                         ccm.ce.chl.Qtarpon.pval.d5$pval, 
                         ccm.ce.chl.Qtarpon.pval.d6$pval, 
                         ccm.ce.chl.Qtarpon.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.sw.chl.Qtarpon,
                  CCM.RHO=ccm.sw.chl.Qtarpon.rho,
                  MAIN = "SW sub-segment", YLAB = TRUE, XLAB = TRUE,
                  PVAL=c(ccm.sw.chl.Qtarpon.pval.d0$pval, 
                         ccm.sw.chl.Qtarpon.pval.d1$pval, 
                         ccm.sw.chl.Qtarpon.pval.d2$pval, 
                         ccm.sw.chl.Qtarpon.pval.d3$pval, 
                         ccm.sw.chl.Qtarpon.pval.d4$pval, 
                         ccm.sw.chl.Qtarpon.pval.d5$pval, 
                         ccm.sw.chl.Qtarpon.pval.d6$pval, 
                         ccm.sw.chl.Qtarpon.pval.d7$pval ) )
plot.CCM.results( CCM.OUTPUT=ccm.se.chl.Qtarpon,
                  CCM.RHO=ccm.se.chl.Qtarpon.rho,
                  MAIN = "SE sub-segment", XLAB = TRUE,
                  PVAL=c(ccm.se.chl.Qtarpon.pval.d0$pval, 
                         ccm.se.chl.Qtarpon.pval.d1$pval, 
                         ccm.se.chl.Qtarpon.pval.d2$pval, 
                         ccm.se.chl.Qtarpon.pval.d3$pval, 
                         ccm.se.chl.Qtarpon.pval.d4$pval, 
                         ccm.se.chl.Qtarpon.pval.d5$pval, 
                         ccm.se.chl.Qtarpon.pval.d6$pval, 
                         ccm.se.chl.Qtarpon.pval.d7$pval ) )
